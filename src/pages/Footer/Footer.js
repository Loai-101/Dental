    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section footer-about">
          ...
          <p>Your trusted partner for a healthy and beautiful smile. We are committed to providing exceptional dental care in a comfortable environment.</p>
        ...
        <div className="footer-section footer-services">
         ...
         <div className="footer-bottom-content">
           <span>&copy; 2023 Dental Care Clinic. All rights reserved.</span>
